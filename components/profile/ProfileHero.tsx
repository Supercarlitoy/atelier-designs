  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-[rgba(17,17,17,0.08)] bg-white shadow-[0_40px_120px_rgba(15,18,24,0.12)]">
      ...
      <div className="relative px-6 pb-10 pt-8 md:px-12">
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div className="flex items-start gap-6">
            ...
            <div className="text-white">
              <p className="text-xs uppercase tracking-[0.4rem] text-white/70">{profile.location}</p>
              <h1 className="mt-2 text-4xl font-semibold md:text-5xl">{profile.name}</h1>
              <p className="mt-3 max-w-xl text-base text-white/80 md:text-lg">{profile.tagline}</p>
            </div>
          </div>
        ...
        <div className="mt-8 flex flex-wrap gap-3 text-xs uppercase tracking-[0.3rem] text-white/70">
