  ...
  return (
    <section className="rounded-3xl border border-[rgba(17,17,17,0.06)] bg-white/95 p-8 text-black shadow-[0_18px_48px_rgba(15,18,24,0.08)] md:p-12">
      <div className="grid gap-8 md:grid-cols-[2fr,1fr] md:items-start">
        <div>
          <p className="text-xs uppercase tracking-[0.3rem] text-black/75">About</p>
          <p className="mt-3 text-lg text-black/80 md:text-xl">{profile.bio}</p>
        </div>
        <div className="space-y-4">
          <div>
            <p className="text-xs uppercase tracking-[0.3rem] text-black/75">Contact</p>
          ...
          <div>
            <p className="text-xs uppercase tracking-[0.3rem] text-black/75">Highlights</p>
            <ul className="mt-3 space-y-2 text-sm text-black/70">
          ...
          {socialEntries.length ? (
            <div>
              <p className="text-xs uppercase tracking-[0.3rem] text-black/75">Connect</p>
              <ul className="mt-3 space-y-2 text-sm text-black/70">
